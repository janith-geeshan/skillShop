...
if (!isset($_SESSION["logged_in"]) || $_SESSION["logged_in"] != true) require_once "process/authCheck.php";
...
<div class="min-h-screen" style="background: #f8fafc;">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-blue-900" style="min-height: 280px;">
        <?php if ($p["image_url"]): ?>
            <img src="<?= $p["image_url"] ?>" class="absolute inset-0 w-full h-full object-cover opacity-10 scale-105 blur-sm
        pointer-events-none">
        <?php endif; ?>
            ...
            <div class="flex-1 min-w-0 space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        <?php foreach (["Full Course Access", "Lifetime Access", "Direct Support", "Recources", "Certificate", "Expert Content"] as $f): ?>
                        ...
                        <div class="grid sm:grid-cols-3 gap-4">
                            ...
                            hover:shadow-md transition-all">
                                    <div class="h-28 bg-slate-200 overflow-hidden">
                                        <?php if ($r["image_url"]): ?>
                                            <img src="<?= $r["image_url"] ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                                        <?php endif; ?>
                                    </div>
                                    <div class="p-3">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-xl">
                        ...
                        <div class="p-5">
                            ...
                            <?php if ($bought): ?>
                                ...
                                bg-green-50 border-2 border-green-300">✔ Already Enrolled</div>
                            ...
                            <?php elseif (!$loggedIn): ?>
                                ...
                                <a href="index.php" class="block w-full py-3.5 text-center bg-gradient-to-r from-blue-600 to-indigo-600
                                hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-xl transition-all
                                active:scale-95 shadow-md mb-3">Sign in to Enroll</a>
                            ...
                            <?php else: ?>
                                <div class="text-center py-3 text-sm text-gray-400 mb-4">
                                    Sellers can't enroll
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="space-y-2.5 text-sm border-t border-slate-100 pt-4">
                                <?php foreach (
                                    [
                                        ...
                                        ["⭐", "Rating", $avgR > 0 ? "$avgR/5 ($revC reviews)" : "No reviews yet"],
