        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <form id="productForm" enctype="multipart/form-data" class="p-8">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="productTitle" placeholder="Enter product title" value="<?php echo $product["title"]; ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 
                focus:border-transparent outline-none transition" />
                    <p class="text-xs text-gray-500 mt-1">Max 150 letters</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="5" placeholder="Describe your product in detail .. "
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500
                    focus:border-transparent outline-none transition" maxlength="1000"><?php echo $product["description"]; ?></textarea>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="price" name="price" placeholder="0.00" min="0" step="0.01"
                                class="w-full pl-9 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500
                ...
                <div class="mb-8">
                    <label for="productImage" class="block text-sm font-medium text-gray-700 mb-2">
                        Product Image (Optional - leave empty to keep current image) <span class="text-red-500">*</span>
                    </label>
                    ...
                    <input type="file" name="productImage" id="productImage" accept="image/*" class="hidden" />
                ...
                <!-- Error msg -->
                <div class="mb-6 p-4 rounded-lg hidden" id="form-message"></div>

                <!-- submit button -->
                <div class="flex gap-4">
                    <button type="submit" class="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold 
                    py-3 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all transform hover:scale-105">
                        Update Product
                    </button>
                    <a href="seller-dashboard.php" class="flex-1 bg-gray-300 text-gray-800 font-semibold py-3 rounded-lg 
                    hover:bg-gray-400 transition-colors text-center">Cancel</a>
                </div>
...
<script>
    ...
    productForm.addEventListener("submit", async (e) => {
        ...
        if (!productTitle) {
            ...
            showError("Product titile must be less than 150 characters.");
        } else if (!description) {
