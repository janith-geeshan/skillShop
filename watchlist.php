            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" id="watchlist-grid">
                ...
                ?>
                    <article class="group relative bg-white/80 backdrop-blur rounded-2xl border border-gray-100 shadow-lg hover:shadow-2xl overflow-hidden transition-all duration-300 hover:translate-y-1" data-product-id="<?= $p["id"]; ?>">
                        ...
                        <button type="button" class="wl-heart absolute top-3 right-3 z-20 w-10 h-10 flex items-center justify-center rounded-full bg-white/90 backdrop-blur shadow-md text-rose-500 hover:scale-110 active:scale-85 transition-transform" data-product-id="<?= $p["id"]; ?>" title="Remove from watchlist">
